/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8be36c150f6c66ff9526a10a5cbbfb1)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	...
	OPENAI_CHATKIT_DOMAIN_KEY: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_WEBHOOK_SECRET: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_DATABASE_ID: string;
	CLOUDFLARE_D1_TOKEN: string;
	Extractor: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").ExtractorAgent>;
	Watcher: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").WatcherAgent>;
	Evaluator: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").EvaluatorAgent>;
	Notifier: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").NotifierAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.svelte-kit/cloudflare/_worker");
		durableNamespaces: "ExtractorAgent" | "WatcherAgent" | "EvaluatorAgent" | "NotifierAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "OPENAI_API_KEY" | "OPENAI_CHATKIT_WORKFLOW_ID" | "OPENAI_CHATKIT_DOMAIN_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_WEBHOOK_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
